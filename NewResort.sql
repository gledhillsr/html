...
--
-- Database: `CasperMountain`
--
CREATE DATABASE IF NOT EXISTS `CasperMountain` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `CasperMountain`;
...
('CasperMountain', '0', 3, '0', '0', '0', '1', 0, '13-11', '29-03', 0, '01-01-21', '01-01-21', 0, '0000-00-00', 0, 127);
...
CREATE TABLE IF NOT EXISTS `roster` (
  ...
  `newPassword` varchar(128) DEFAULT '',
    ) ENGINE=MyISAM DEFAULT CHARSET=latin1;
