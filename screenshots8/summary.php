...
echo "$query_string<br>";
        $result = @mysqli_query($connect_string, $query_string) or die ("Invalid query 9A");
    }
    if($startLockoutBtn) {

        $query_string = "UPDATE directorsettings SET signinLockout=\"" . ($now + 7200) . "\" WHERE 1";
echo "$query_string<br>";
        $result = @mysqli_query($connect_string, $query_string) or die ("Invalid query 9Aa");
    }
...
//echo "$query_string<br>";
//    $result = @mysqli_query($connect_string, $query_string) or die ("Invalid query 6.5");
