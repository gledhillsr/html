...
function readRecord($id) {
    global $mysqli_host, $mysqli_username, $mysqli_password, $area,$minLevel,$description,$topShack,$startTime;
    global $endTime,$topShack2,$startTime2,$endTime2,$lateSweep,$mysqli_db,$getAreaShort;
...
echo "old=$last, new=$txt\n";
  if(strcmp((string) $last,(string) $txt) == 0)
    $sel = "selected";
  else
    $sel = "";
