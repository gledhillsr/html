...
echo "<div align=center>\n";
echo "  <center>\n";
echo "<br><font size=5>---Uploading 'skihistory' from $mysqli_host to $gledhills_host---<br></font>\n";
echo "  <table border=1 cellpadding=0 cellspacing=0 style=\"border-collapse: collapse\" bordercolor=\"#111111\" width=500 >\n";
echo "    <tr>\n";
if(!isset($startPatroller)) 
    echo "      <td bgcolor=\"#0000FF\" width=$left>&nbsp;</td>\n";
...
if (isset($startHistoryID)) {
    ...
    $connect_string = @mysqli_connect($gledhills_host, $mysqli_username, $mysqli_password) or die ("Could not connect to the database.");
	mysqli_select_db($connect_string, $mysqli_db);
	...
	$result = @mysqli_query($connect_string, $query_string) or die ("Error: old_skihistory DROP Failed on " . $query_string . " MYSQL error:" .mysqli_error() );
echo "&nbsp;&nbsp;&nbsp;'$query_string' was Successful<br>";  //drop tmp table
	...
	$result = @mysqli_query($connect_string, $query_string) or die ("  - $tmp_history CREATE Failed on " . $query_string . " MYSQL error:" . mysqli_error() );
echo "&nbsp;&nbsp;&nbsp;'$tmp_history' CREATE Successful<br>";	//create tmp table
	...
	echo "$query_string<br>";
	$result = @mysqli_query($connect_string, $query_string) or die ("  - $tmp_history INSERT Failed on " . $query_string . " MYSQL error:" . mysqli_error());
	$count++;
    }
	...
	$result = @mysqli_query($connect_string, $query_string) or die ("Error: $new_skihistory DROP Failed on " . $query_string . " MYSQL error:" .mysqli_error() );
