...
$getTopShack  = [-1 => "Unassigned",0 => "Crest Top Shack",   1 => "Snake Creek", 2 => "Western Top", 3 => "Millicent Top", 4 => "Aid Room 1", 5 => "Aid Room 2"];
$getTopShackDBName  = [0 => "Crest Top Shack",   1 => "Snake Creek Top", 2 => "Majestic Top", 3 => "Western Top", 4 => "Millicent Top", 5 => "Aid Room 1", 6 => "Aid Room 2"];
$areaCount = 6;
