...
////echo "$query_string ";
//	$result = @mysqli_query($connect_string, $query_string) or die ("Invalid query.  Cannot query syncEnabled");
...
//			$result = @mysqli_query($connect_string, $query_string) or die ("SYNC change NOT made");
