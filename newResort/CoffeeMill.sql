...
-- Database: `CoffeeMill`
--
CREATE DATABASE IF NOT EXISTS `CoffeeMill` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `CoffeeMill`;
...
('Coffee Mill Mountain', '0', 3, '0', '0', '0', '1', 0, '13-11', '29-03', 0, '01-01-15', '01-01-15', 0, '0000-00-00', 0, 127);
