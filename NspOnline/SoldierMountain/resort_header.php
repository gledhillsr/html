...
require("config.php");
    ...
    $resortFull = "Soldier Mountain";
    $resort     = "SoldierMountain";
	$resortURL  = "http://www.soldiermountain.com/";
	$resortImg  = "images/SoldierMountain.gif";
	$imgHeight   = 70;
...
<table border="0"  cellspacing="0" cellpadding="0" width="932" >
  <tr>
    <td>
    <a href="<? echo $resortURL; ?>"><img border="0" src="<? echo $resortImg; ?>" heigth="<? echo $imgHeight; ?>" height="60"></a>
    </td>
    <td align="center">
