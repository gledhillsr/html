...
require("config.php");
    ...
    $resortFull = "SnowBird";
    $resort     = "SnowBird";
	$resortURL  = "http://www.snowbird.com";
	$resortImg  = "images/showbird.jpg";
	$imgWidth   = 50;
...
-->
<img border="0" src="images/snowhosts.gif" height="90">
    </td>
  </tr>
...
<a class="button" target="main" href="/nspCode/MemberList?resort=<? echo $resort; ?><? echo $userID; ?>">Hosts</a>
