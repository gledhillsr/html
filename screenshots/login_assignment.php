...
if ($ID) {
    ...
    //echo $query_string . "<br>";
    $result = @mysql_db_query($mysql_db, $query_string) or die ("Invalid query1 ($mysql_db, $query_string)");
    $inTraining = 1;
...
function checkForDoubleShift() {
  global $currShift, $mysql_db, $doubleShift, $today, $ID;
...
//      echo "$query_string<br>";
      $result1 = @mysql_db_query($mysql_db, $query_string) or die ("Invalid query ($query_string<br>");
