...
//echo "$today<br/>";
//echo "calling Autofill =" . $AutoFill . "<br/>";
//**  $AutoFil =& $_POST['AutoFill']  //same address
//**  $AutoFil = $_POST['AutoFill']   //dup of memory
    if($AutoFill) {
...
<div style="height:auto;width:782">
  <table border="1" width="800" cellspacing="0" cellpadding="0">
    <tr>
      <td width="175" bgcolor="#E1E1E1" rowspan="2">
        <p align="center">&nbsp;<b><? echo $areaName; ?></b><br>Patroller&nbsp;Assignments</p></td>
      <td width="623" bgcolor="#EBEBEB" colspan="5">
        <p align="center"><b><? echo $areaName; ?></b> Work Assignments</p></td>
    </tr>
    <tr>
...
?>
<div style="overflow:auto;height:300px;width:812">
  ...
  <table border="1" width="800" cellspacing="0" cellpadding="0">
    <tr>
      <td width="265" bgcolor="#C4FBF8">
        <p align="center"><? echo $unassignedCnt; ?> patroller slot(s) unassigned</p></td>
