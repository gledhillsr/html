...
//$connect_string = @mysqli_connect($gledhills_host, $mysql_username, $mysql_password) or die ("Could not connect to the database at $gledhills_host.");
...
// ===================================
    ...
    $connect_string = @mysqli_connect($gledhills_host, $mysql_username, $gledhills_mysql_password) or die ("Could not connect to the database.");
