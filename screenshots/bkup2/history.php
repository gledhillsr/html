...
//        $multiplier = 4/3;  //1.33334;
        $multiplier = 1;  //1.33334;
	} else if($multiplier == 3) {
//        $multiplier = 1/3; // 0.33334;
        $multiplier = 0; // 0.33334;
	}
...
//  echo "  <td align=\"center\">" . number_format($credit, 2, '.', ',') . "</td>\n";
  if($admin) {
    //only show "edit" button if an administrator
  	echo "<td align=\"center\"><a href=\"edit_history.php?ID=$ID&edit=$history_id\"><img border=\"0\" src=\"Edit.jpg\" width=\"27\" height=\"14\"></a></td>";
  }
  echo "</tr>\n";
}
  ...
  if($admin && $ID) echo "<td align=\"center\"><a href=\"edit_history.php?ID=$ID&add=1\">Add</a></td>";
    ...
    echo "<td align=center colspan=3 bgcolor=\"#FFFF00\">$totalNights Nights</td>\n";
