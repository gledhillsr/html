...
<h2>Define Sweeps, with definitions and requirements.</h2>
  ...
  <table width="682" border="1" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
    <tr>
      <td bgColor="#FFFFFF" colspan="7" bordercolor="#000000" width="680">
        <p align="center">Assignments (sorted by Top Shack, then by Start Shift Time)</p>
      </td>
    </tr>
    <tr>
      ...
      <td align="middle" width="196" bgColor="#FFFFFF" bordercolor="#000000"><font size="2"><b>AM Sweep</b></font></td>
      ...
      <td align="middle" width="78" bgColor="#FFFFFF" bordercolor="#000000"><font size="2"><b>Late Sweep</b></font></td>
      <td align="middle" width="92" bgColor="#FFFFFF" bordercolor="#000000">
      <a href="edit_assignment.php?new=1">
      <img border="0" src="new.jpg" width="33" height="17"></a></td>
    </tr>
<?
...
//    $connect_string = @mysql_connect($mysql_host, $mysql_username, $mysql_password) or die ("Could not connect to the database.");
    ...
    while ($row = @mysql_fetch_array($result)) {
        ...
        echo "  <td                  width=\"196\" bgColor=\"#FFFFFF\" bordercolor=\"#000000\"><font size=\"2\">&nbsp;&nbsp;$description</font></td>\n";
        ...
        echo "  <td align=\"middle\" width=\"78\" bgColor=\"#FFFFFF\" bordercolor=\"#000000\"><font size=\"2\">$closing</font></td>\n";
        ...
        echo "  <img border=\"0\" src=\"Edit.jpg\" width=\"27\" height=\"14\"></a>&nbsp;&nbsp;&nbsp;";
        echo "  <a href=\"edit_assignment.php?delete=1&id=" . $row[ id ] . "\">\n";
        echo "    <img border=\"0\" src=\"delete.jpg\" width=\"46\" height=\"14\"></a></font></td>\n";
        echo "</tr>\n";
    }
?>
  </table>
