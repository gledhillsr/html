...
//    header("Location: Synchronize.php?startPos=0"); /* Redirect browser */
	...
	if($syncRosterBtn) {
//    header("Location: Synchronize.php?startPos=0"); /* Redirect browser */
    header("Location: sync4.php"); /* Redirect browser */
...
echo "<h1>Sync the ROSTER from the Internet, DOWN to this machine</h1>";
    echo "<input disabled type=submit value=\"Syncronize Roster Down from Web\" name=\"syncRosterBtn\">&nbsp;&nbsp;&nbsp;&nbsp;May take a few minutes.<br><br><br>\n";
//	if($enableSync) {
//		$strEnable = "Enabled";
