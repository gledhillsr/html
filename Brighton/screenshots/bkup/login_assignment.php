...
//8 => "Monday 11:45pm");
        ...
        case 6: $currDayOfWeek = "Monday";      $hr = 15;  $min = 15; break;
...
//
    while ($row = @mysql_fetch_array($result)) {
        ...
        $open = $row[ open ];  		//is the hill open 0=closed, 1=open, 2=always open (training/staff)
...
//debug
        ...
        if($open == 2 || 							//training/Staff or
        		$isSwingOnCrest || 					//Crest on Swing/Night is always available or
        		($currID == 0 && $available <= 0))	//crest and available <= 0, don't print it's confusing
            echo "&nbsp;";
        else
            echo $available;
        echo "</td>\n";
