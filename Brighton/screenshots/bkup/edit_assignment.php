...
function readRecord($id) {
    global $area,$minLevel,$description,$topShack,$startTime,$endTime,$topShack2,$startTime2,$endTime2,$lateSweep,$mysql_db,$getAreaShort;
...
//echo "new area=$area<br>\n";
    ...
    . "this is a very long description, but you don't need to use the enter key when typing it in, "
    . "then I will format it better for the report>\n#<chore 4>\n\n   First line is the TITLE, then a '@' "
    . "starts a new LOCATION, and each '#' starts a new CHORE at that location.  You can have as many chores "
...
function updateAreas(selObject) {
	...
	if(idx == 0) {			//Crest
		...
		document.myForm.minLevel.selectedIndex = 2; 
		document.myForm.topShack.selectedIndex = 4; 
		document.myForm.topShack2.selectedIndex = 7; 
...
?>
      ...
      &nbsp; (Normally Only Majestic goes here)</td>
    <tr>
