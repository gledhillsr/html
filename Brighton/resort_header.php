...
<!-- <a class="button" href="/calendar-1/MonthCalendar?resort=<?php echo $resort; ?>&noLogin=1<?php echo $userID; ?>" target="main">Calendar</a>&nbsp;&nbsp; -->
...
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/MonthCalendar?resort=<?php echo "$resort$userID"; ?>">Online Schedule</a>
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/ListAssignments?resort=<?php echo "$resort$userID"; ?>">My Assignments</a>
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/SubList?resort=<?php echo "$resort$userID"; ?>">Sub List</a>
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/UpdateInfo?resort=<?php echo "$resort$userID"; ?>">My Info</a>
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/CustomizedList2?resort=<?php echo "$resort$userID$reportDetails"; ?>">Patrollers</a>
<a class="button" target="main" href="http://nsponline.org:8080/calendar-1/Directors?resort=<?php echo "$resort$userID"; ?>">Directors</a>
</div>
</font></b>
    </td>
  </tr>
