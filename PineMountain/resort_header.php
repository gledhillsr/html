...
require("config.php");
    ...
    $resortFull = "Pine Mountain";
    $resort     = "PineMountain";
	$resortURL  = "http://www.PineMountainResort.com";
	$resortImg  = "PineMtnLogo.png";
...
<table border="0"  cellspacing="0" cellpadding="0" width="932" >
  <tr>
    <td>
    <a href="<? echo $resortURL; ?>"><img border="0" src="<? echo $resortImg; ?>" width="105" height="70"></a>
    </td>
    <td align="center">
