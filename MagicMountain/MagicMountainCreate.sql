...
-- Database: `ZZZZZZ`
--
CREATE DATABASE IF NOT EXISTS `MagicMountain` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `MagicMountain`;
...
('Magic Mountain', '0', 3, '0', '0', '0', '1', 0, '13-11', '29-03', 0, '01-01-15', '01-01-15', 0, '0000-00-00', 0, 127);
