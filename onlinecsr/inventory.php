...
<?
  ...
  while ($row = @mysql_fetch_array($result))
   ...
   $field_9 = $row[ $btn_field[2][18] ];

   $page_total =  $field_9 + $page_total;

   $field_10 = $row[ $btn_field[2][19] ];

   $page_so_total = $field_10 + $page_so_total;
...
//zzz $customer_id
   ...
   if($field_9 == 0.0)
      ...
      $jump = "<a href=\"/CSR_home/$customer_id/BTN/html/{$link}_MS.html\">\$$jump</a>";
...
//$field_10=-43.21;
   $jump = sprintf("%.2f", $field_10);
   if($field_10 == 0.0)
	  $jump = "\$$jump";
   else
      $jump = "<a href=\"/CSR_home/$customer_id/BTN/html/{$link}_SO.html\">\$$jump</a>";
   ...
   echo "<td align=\"right\" $hilightColor $wrap><font size=\"2\" color=\"$text_color\">$jump</font></td>\n";
// -- end 
...
$foo = yellow;
   ...
   $jump2 = sprintf("%.2f", $page_so_total);
   ...
   echo "<td align=\"right\" nowrap><font size=\"2\" color=\"$text_color\">\$$jump</font></td>";
   echo "<td align=\"right\" nowrap><font size=\"2\" color=\"$text_color\">\$$jump2</font></td><td></td><td> </td>\n";
   echo "</tr>";
  echo "\n</table>";
