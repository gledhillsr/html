...
$cur_page="edit_amc";
$page_title = "Inventory Management Service - Adds, Moves and Changes Editor";  // Page title
...
"<a class=\"nav3\" href=\"help_amc_edit.htm\">Help</a>&nbsp;&nbsp;&nbsp;&nbsp;" .
...
global $edit_field4, $edit_field10, $user_table, $user_field, $edit_field12, $UsersNotified, $edit_field13;
...
?>
 ...
 <tr>
  ...
  <td>
<?
	$dueDate = $amc_row[ $amc_field[2][13] ];
	if($dueDate == 0)
		$strDue = "";
	else
		$strDue = date("m/d/y",$dueDate);
	echo "<input type=\"text\" size=\"20\" maxlength=\"20\" class=\"input\" name=\"edit_field13\" value=\"" . $strDue . "\">";
//	echo "<input type=\"text\" onchange=\"checkDate(this)\" size=\"20\" maxlength=\"20\" class=\"input\" name=\"edit_field13\" value=\"" . $strDue . "\">";
  echo "  (mm/dd/yy) "; // or +[num][unit] <br>eg. \"+2w\" (2 weeks from now) or \"+3m\" (3 months from now)<br>valid units are \"d\" (days), \"w\" (weeks) \"m\" (months)";
//	echo "<input type=\"button\" value=\"Format Examples\" onClick=window.location=\"amc.php\" >";
//	echo "<input type=\"button\" value=\"Format Examples\" onClick=Window.open(\"index.php\", \"helpWindow\") >";
//echo "<a href=\"#\" onClick=\"MyWindow=window.open(\'http://www.yahoo.com\',\'MyWindow\',\'toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,width=400,height=300,left=20,top=20\'); return false;\">open window</a>";	
?>
&nbsp;&nbsp;&nbsp;
<a href="dateFormat.php" onClick="MyWindow=window.open('dateFormat.php','MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,width=360,height=400,left=20,top=20')
return false;">see Format Examples</a>
  </td>
 </tr> 
...
global $customer_id, $customer_name, $btn_field, $user_id, $edit_field12, $edit_field13;
...
//echo $query_string . "<br>";
 ...
 if (($dueDate = strtotime($edit_field13)) === -1) {
	 $dueDate = 0;	//bogus value
echo "Invalid due date.  setting due date to \"none\".<br>"; 
 } else {
//echo "due date set to " . $dueDate . " was (" . $edit_field13 . ") = " . date("l, F d, Y - h:i A",$dueDate) . "<br>"; 
 }
 //???	echo date("l, F d, Y - h:i A",$edit_field4);
...
//on add, insert current time
   ...
   $query_string = "INSERT INTO " . $amc_table . " (" . 
   		...
   		$amc_field[2][10] . ", " . $amc_field[2][11] . ", " . $amc_field[2][12] . ", " . 
   		$amc_field[2][13] .") VALUES (\"" . 
