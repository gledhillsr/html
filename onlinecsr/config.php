...
$mysql_password = "";    // MySQL password (leave empty if no password is required.)
...
$btn_field[1][18] = "Monthly<br>Service";   // Column 18
$btn_field[1][19] = "Service<br>Order";     // Column 19
//---------- user --------
...
$btn_field[2][18] = "MonthlyService"; 	// MySQL float
$btn_field[2][19] = "ServiceOrders"; 	// MySQL float
