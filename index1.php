        ...
        <div class="col">
          <a href="<?= htmlspecialchars($patrol['href']) ?>" class="text-decoration-none text-dark">
            <div class="card station-card d-flex flex-row align-items-center">
              <img src="<?= htmlspecialchars($patrol['img']) ?>" class="me-3" alt="<?= htmlspecialchars($patrol['name']) ?>">
              <div>
                <h5 class="card-title mb-1"><?= htmlspecialchars($patrol['name']) ?></h5>
                <p class="card-text mb-0">Ski Patrol Online Scheduling</p>
              </div>
            </div>
          </a>
        </div>
