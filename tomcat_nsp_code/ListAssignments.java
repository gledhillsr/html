...
//System.out.println("ListAssignment: ID="+request.getParameter("ID"));
        CookieID cookie = new CookieID(request,response,"ListAssignments",null);
        if(cookie.error)
            return;
...
//      out.println("<h3><img border=\"0\" src=\"/nspImages/ski_accident_md_wht.gif\" width=\"140\" height=\"120\"></h3>");
        out.println("<h1><img border=\"0\" src=\"/nspImages/ski_accident_md_wht.gif\" align=top>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shift Summary</h1>");
    }
...
//====================================================================		 
		 calendar.set(2006,3,1);  //(yyyy,mm,dd) Month is 0 based
//====================================================================		 
...
//        boolean isWeekendDay = false;
        for(i=0; i < Assignments.MAX; ++i) {
            if(ns.getPosID(i) == null || ns.getPosID(i).equals("")) continue;
            try {
