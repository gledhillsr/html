...
//  System.out.println("Assignment.read="+this);
    ...
    public int getYear()        { return Integer.parseInt(szDate.substring(0,4));  }
    public int getMonth()       { return Integer.parseInt(szDate.substring(5,7));  }
    public int getDay()         { return Integer.parseInt(szDate.substring(8,10)); }
    ...
    public String getStartingTimeString()   {  return szStartTime; }
    public String getEndingTimeString()     {  return szEndTime;   }
    public String getEventName()            {  return szEventName; }
    public int getType()                    {  return type;       }
    public int getCount()                   {  return count;       }
    public boolean exists()                 {  return existed;     }
    public String getDateOnly()             {  return szDate.substring(0,10); }
    public String getDate()                 {  return szDate; }
    /*************************************************************************/
    /* getTypeID
    /*************************************************************************/
...
//System.out.println("Found "+cnt+") patroller=("+patrollerID[i]+")");			
    ...
    /* setters
    /*************************************************************************/
    public void setDate(String newDate)     {  szDate = newDate;   }
    public void setStartTime(String str)    {  szStartTime = str;  }
    public void setEndTime(String str)      {  szEndTime = str;    }
    public void setEventName(String str)    {  szEventName = str;  
//    System.out.println("1 szEventName=("+szEventName+")");
}
    public void setType(int cnt)            {  type = cnt;        }
    public void setCount(int cnt)           {  count = cnt;        }
    public void setExisted()                {  existed = true;     }
    public void setExisted(boolean flag)    {  existed = flag;     }
...
//System.out.println(toString());
    ...
    public String getUpdateQueryString() {
        int i;
        if(szEventName.indexOf('"') != -1)  szEventName = szEventName.replace('"', '\'');
        if(szStartTime.indexOf('"') != -1)  szStartTime = szStartTime.replace('"', '\'');
        if(szEndTime.indexOf('"') != -1)    szEndTime   = szEndTime.replace('"', '\'');
