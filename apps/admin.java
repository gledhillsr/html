...
*/
    ...
    /**
     * STARTUP FOR JAVA APPLIT
     */
    public void init() {
		frame = new JFrame("Needs a Title");
		applet = new admin();
...
//display User List
    ...
    private void initComponents() {
        ...
        fixBtnButton.setFont(new java.awt.Font("MS Sans Serif", 0, 10));
        fixBtnButton.setText("Zero Totals, Normalize BTN's");
        ...
        jPanel15.add(fixBtnButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 180, -1));
...
//..                    if(BTNfile.isBtnFile(file)) {
//System.out.println("  is BTN file.");
//..                        btnFiles.add(new BTNfile(file,frame,customer));
//..                    } else {
//System.out.println("  -NOT- BTN file.");
//System.out.println("evaluating "+file.getName());
                        if(file.getName().equals("SOACTVTY.DET")  && evt.getValueIsAdjusting()==false ) {
System.out.println("found Service Order Activity file: "+file.getName());
                            serviceOrder = new SOActivity(file,frame,customer,SOBtns);
                        }
                        else if(file.getName().equals("MONSERV.DET") && evt.getValueIsAdjusting()==false) {
//System.out.println("found Monthly Service Description file: "+file.getName()+"evt="+evt);
//System.out.println("hack!!! monthly service commented out!!!!!");
                            monthService = new MonthlyService(file,frame,customer,btnFiles);
                        }
//..                    }
                }
            }
