...
//$home 	= 5;
//$email 	= 4;
//NSP_ID(0), PREFIX, FIRST(2), MIDDLE, LAST(4), SUFFIX, FULL_NAME, EMAIL(7), HOME_PHONE(8), FAX,
//ADDRESS_1(10), ADDRESS_2, CITY(12), STATE_PROVINCE(13), ZIP(14), COUNTRY, BIRTH_DATE,
//GENDER, CATEGORY(18), JOIN_DATE, PAID_THRU, TITLE, PRO, NATL_NUM, YEAR_NATL,
//CERT_NUM, LCA_NUM, LIFETIME, INACTIVE, BASIC_A_YR, BASIC_M_YR, ADV_A_YR, ADV_M_YR,
//OEC, OEC_REFA, OEC_REFB, OEC_REFC, PES, PHASE_I, ALPTOB_IN_EXP, AVAL_IN_EXP,
//ADVAV_IN_EXP, MTN_IN_EXP, NST_IN_EXP, OEC_IN_EXP, PE_IN_EXP, PHI_IN_EXP, ALPTOB_IT,
//AVAL_IT, MTN_IT, NST_IT, OEC_IT, PES_IT, PHASEI_IT, ATII, AVALII, GLOBALII, MTNII, NSTII,
//OECII, SEC_PAT, SEC_VOL, SEC_YEAR, SEC_CATEGORY, SES, TES, PAT\
